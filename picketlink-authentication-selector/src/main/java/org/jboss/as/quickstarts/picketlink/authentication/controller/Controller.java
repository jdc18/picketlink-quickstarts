 ...
 */
package org.jboss.as.quickstarts.picketlink.authentication.controller;
...
public class Controller {
	...
	public String getStackTrace() {
		Throwable throwable = (Throwable) FacesContext.getCurrentInstance().getExternalContext().getRequestMap()
